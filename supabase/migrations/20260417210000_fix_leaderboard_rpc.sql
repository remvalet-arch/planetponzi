-- Fix pp_leaderboard_top50 : filtre meta sans regex (~), casts entiers + bornes numériques.
-- (Les regex sur ->> rejetaient silencieusement des valeurs JSON numériques ou formats marginaux.)
