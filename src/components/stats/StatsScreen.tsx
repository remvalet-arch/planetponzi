        ...
        <ul className="space-y-2">
          {DECK_CHALLENGE_LEVELS.map((lvl) => {
            ...
            return (
              <li
                key={lvl}
                className={`${rowCard} flex flex-col gap-2 px-3 py-2.5 sm:flex-row sm:items-start sm:justify-between sm:gap-4`}
              >
                <div className="min-w-0 flex-1">
                  <p className="break-words font-mono text-xs font-semibold text-slate-100 sm:truncate">
                ...
                <dl className="grid min-w-0 w-full grid-cols-3 gap-2 font-mono text-[10px] tabular-nums sm:w-auto sm:max-w-[min(100%,20rem)] sm:shrink-0 sm:gap-4 sm:text-xs">
                  ...
                  <div className="min-w-0">
                    ...
                    <dd className="break-words font-bold text-slate-200">{avg}</dd>
                  </div>
                  <div className="min-w-0">
                    <dt className="text-slate-500">Record</dt>
                    <dd className="break-words font-bold text-emerald-300">{best}</dd>
                  </div>
                </dl>
              </li>
            );
