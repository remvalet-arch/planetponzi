...
export function SettingsCeoDisplayName() {
  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-3 rounded-pp-xl pp-panel-sci p-4">
      ...
      <input
        ...
        className="rounded-pp-lg border border-white/10 bg-[#15161E] px-3 py-2 font-mono text-sm text-slate-100 placeholder:text-slate-500 focus:border-cyan-500/50 focus:outline-none"
      />
