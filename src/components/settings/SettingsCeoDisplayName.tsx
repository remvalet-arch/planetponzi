...
export function SettingsCeoDisplayName() {
  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-3 rounded-pp-xl border border-pp-border-strong bg-pp-elevated/60 p-4">
      <p className="font-mono text-[10px] uppercase tracking-widest text-pp-text-dim">{t.ceoDisplayName.kicker}</p>
      <h2 className="font-mono text-sm font-bold text-pp-text">{t.ceoDisplayName.title}</h2>
      ...
      <label className="font-mono text-[10px] uppercase tracking-widest text-pp-text-dim" htmlFor="settings-ceo-name">
      ...
      {hint === "ok" ? <p className="font-mono text-xs text-pp-accent">{t.ceoDisplayName.saved}</p> : null}
