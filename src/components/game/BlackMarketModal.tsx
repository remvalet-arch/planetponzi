  ...
  return (
    ...
    >
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-visible overscroll-y-contain">
        <div className="min-h-0 shrink-0 px-2 pb-2 pt-8">
          <BoardComicShell
            variant="modal"
            mood="greedy"
            title={copy.title}
              ...
              {ALL_TYPES.map((bt) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-[9px] uppercase tracking-wider text-slate-400 sm:text-[10px]">
                      {bt}
                    </span>
                    ...
                    <span className="font-mono text-[10px] tabular-nums text-amber-200/90">
                      {BLACK_MARKET_TILE_COST} 💰
                    </span>
                  </button>
                );
              })}
